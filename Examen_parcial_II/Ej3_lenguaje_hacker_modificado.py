...
def convertir_texto(texto_ingresado,diccionario_basico,diccionario_intermedio,diccionario_digitos):
    texto_convertido = ""
    texto_auxiliar = ""
    if opcion == 1: # ................................ Convertir a lenguaje básico.
        for caracter in texto_ingresado:
            texto_auxiliar += diccionario_digitos.get(caracter,caracter)  # Se remplaza el digito si este existe en el diccionario.
        for caracter in texto_auxiliar:
...
def seleccion(opcion):
    if opcion == 1 or opcion == 2:
        ...
        texto_covertido = convertir_texto(texto_ingresado, diccionario_basico,diccionario_intermedio,diccionario_digitos)
    elif opcion == 3:
        print("Saliendo...")
    else:
...
diccionario_intermedio = {'a': '4','A': '4','b': 'l3','B': 'l3','c': '[','C': '[','d': ')','D': ')','e': '3','E': '3','f': '|=','F': '|=','g': '&','G': '&','h': '#','H': '#','i': '1','I': '1','j': ',_|','J': ',_|',
                                           ...
                                           't': '7','T': '7','u': '(_)','U': '(_)','v': '\/','V': '\/','w': '\/\/','W': '\/\/','x': '><','X': '><','y': 'j','Y': 'j','z': '2','Z': '2','0': 'o','1': 'l','2': 'R','3': 'E','4': 'A','5': 'S','6': 'b','7': 'T','8': 'B','9': 'g'}
# Diccionario de digitos
diccionario_digitos = {'0': 'o','1': 'l','2': 'R','3': 'E','4': 'A','5': 'S','6': 'b','7': 'T','8': 'B','9': 'g'}
