...
def iniciar_test():
    ...
    preguntas = [{"pregunta": "¿Cuál de las siguientes opciones odiarías más que la gente te llamara?","respuestas": {"Gryffindor": "Ordinario","Slytherin": "Ignorante","Hufflepuff": "Cobarde","Ravenclaw": "Egoísta"}},
                ...
                {"pregunta": "¿Cuál de los siguientes superpoderes prefieres tener?","respuestas": {"Gryffindor": "Invisibilidad", "Slytherin": "Dormir", "Hufflepuff": "Superfuerza","Ravenclaw": "Teletransportarse"}}
    ]
